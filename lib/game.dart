  ...
  for (int i = userInputRow - 1; i >= 1; i--) {
    ...
    if (a == b) {
      ...
      if (music) {
        switch (row[i]) {
          case 4:
            await player.play(AssetSource('music/4.mp3'));
            break;
          case 8:
            await player.play(AssetSource('music/8.mp3'));
            break;
          case 16:
            await player.play(AssetSource('music/16.mp3'));
            break;
          case 32:
            await player.play(AssetSource('music/32.mp3'));
            break;
          case 64:
            await player.play(AssetSource('music/64.mp3'));
            break;
          case 128:
            await player.play(AssetSource('music/128.mp3'));
            break;
          case 256:
            await player.play(AssetSource('music/256.mp3'));
            break;
          case 512:
            await player.play(AssetSource('music/512.mp3'));
            break;
          case 1028:
            await player.play(AssetSource('music/1024.mp3'));
            break;
          case 2048:
            await player.play(AssetSource('music/2048.mp3'));
            break;
          case 4096:
            await player.play(AssetSource('music/4096.mp3'));
            break;
        }
      }
      score += row[i];
